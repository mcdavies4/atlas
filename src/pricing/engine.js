...
const PRICING = {
  central: {
    central: { base: 1500, label: 'Within Central Abuja' },
    inner:   { base: 2500, label: 'Central → Inner' },
    outer:   { base: 4000, label: 'Central → Outer' },
  },
  inner: {
    central: { base: 2500, label: 'Inner → Central' },
    inner:   { base: 2000, label: 'Within Inner Zone' },
    outer:   { base: 3500, label: 'Inner → Outer' },
  },
  outer: {
    central: { base: 4000, label: 'Outer → Central' },
    inner:   { base: 3500, label: 'Outer → Inner' },
    outer:   { base: 2500, label: 'Within Outer Zone' },
  },
};
